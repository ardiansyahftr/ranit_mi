...
<body class="off-canvas-sidebar">  
  <div class="wrapper wrapper-full-page">
    <div class="page-header login-page header-filter" filter-color="black" style="background-image: url('assets/img/bg9.jpg'); background-size: cover; background-position: top center;">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id=canvas_pan class="panel-body" >
                        <canvas id="bar-chart-1" width="29" height="167.5"></canvas>
                    </div>
